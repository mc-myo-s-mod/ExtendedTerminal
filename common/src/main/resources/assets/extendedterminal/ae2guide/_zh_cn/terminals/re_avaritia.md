...
<ItemLink id="extendedterminal:sculk_terminal" />是终端版本的<ItemLink id="avaritia:sculk_crafting_table"/>。
## 炼狱合成终端
<Row>
<ItemImage id="extendedterminal:nether_terminal" scale={3}/>
<ItemImage id="avaritia:nether_crafting_table" scale={3}/>
</Row>
<ItemLink id="extendedterminal:nether_terminal" />是终端版本的<ItemLink id="avaritia:nether_crafting_table"/>。
## 终末合成终端
<Row>
<ItemImage id="extendedterminal:end_terminal" scale={3}/>
<ItemImage id="avaritia:end_crafting_table" scale={3}/>
</Row>
<ItemLink id="extendedterminal:end_terminal" />是终端版本的<ItemLink id="avaritia:end_crafting_table"/>。
## 终焉合成终端
<Row>
<ItemImage id="extendedterminal:extreme_terminal" scale={3}/>
<ItemImage id="avaritia:extreme_crafting_table" scale={3}/>
</Row>
<ItemLink id="extendedterminal:extreme_terminal" />是终端版本的<ItemLink id="avaritia:extreme_crafting_table"/>。
