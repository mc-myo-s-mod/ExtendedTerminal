...
item_ids:
  ...
  - epic_terminal
  - legendary_terminal
  - wireless_epic_terminal
  - wireless_legendary_terminal
---
# 拓展合成终端
...
## 传奇拓展合成终端
        ...
        <ItemLink id="extendedterminal:legendary_terminal" />提供 13×13 合成网格，用于
        <ItemLink id="extendedcrafting:legendary_table" />的配方。
