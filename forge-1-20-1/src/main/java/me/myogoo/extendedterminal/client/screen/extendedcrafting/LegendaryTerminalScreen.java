...
public class LegendaryTerminalScreen extends ETTerminalBaseScreen<ITableRecipe, LegendaryTerminalMenu> {
    public LegendaryTerminalScreen(LegendaryTerminalMenu menu, Inventory playerInventory, Component title,
            ScreenStyle style) {
