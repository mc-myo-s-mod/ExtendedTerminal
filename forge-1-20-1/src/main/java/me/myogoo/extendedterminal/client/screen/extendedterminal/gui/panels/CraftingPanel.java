...
public class CraftingPanel extends ETTerminalModePanel {
    ...
    public CraftingPanel(ETTerminalScreen screen, WidgetContainer widgets, ActionButton clearToStorage,
            ActionButton clearToInv) {
    ...
    public void setVisible(boolean visible) {
        ...
        this.clearToInv.setVisibility(visible);
        this.clearToStorage.setVisibility(visible);
