...
public class ExCraftingTerminalSlot extends ETCraftingBaseSlot<ITableRecipe, CraftingContainer> {
    public ExCraftingTerminalSlot(Player player, IActionSource mySrc, IEnergySource energySrc,
