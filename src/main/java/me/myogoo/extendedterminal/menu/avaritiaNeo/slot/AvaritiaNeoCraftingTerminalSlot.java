...
public class AvaritiaNeoCraftingTerminalSlot extends ETCraftingBaseSlot<RecipeExtremeCrafting, CraftingContainer> {
    public AvaritiaNeoCraftingTerminalSlot(Player player, IActionSource mySrc, IEnergySource energySrc, MEStorage storage, InternalInventory cMatrix, InternalInventory secondMatrix, IMenuCraftingPacket ccp) {
        super(player, mySrc, energySrc, storage, cMatrix, secondMatrix, ccp, ETMenuType.NEO_EXTREME_TERMINAL);
    }

    @Override
    protected RecipeExtremeCrafting findRecipe(CraftingContainer ic, Level level) {
