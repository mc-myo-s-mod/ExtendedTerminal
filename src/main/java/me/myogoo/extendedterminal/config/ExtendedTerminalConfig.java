...
public class ExtendedTerminalConfig implements IETConfig {
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_CRAFTING_PANEL;
    private static final ForgeConfigSpec.BooleanValue ENABLE_SMITHING_PANEL;
    private static final ForgeConfigSpec.BooleanValue ENABLE_STONECUTTER_PANEL;
    private static final ForgeConfigSpec.BooleanValue ENABLE_ANVIL_PANEL;
