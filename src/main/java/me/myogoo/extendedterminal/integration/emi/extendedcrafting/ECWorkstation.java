...
public class ECWorkstation {
    ...
    public static void register(EmiRegistry registry) {
        ...
        registry.addWorkstation(ECRecipeCategory.BASIC_TABLE_CRAFTING_CATEGORY, EmiStack.of(ETParts.BASIC_TERMINAL_PART));
        ...
        registry.addWorkstation(ECRecipeCategory.ADVANCED_TABLE_CRAFTING_CATEGORY, EmiStack.of(ETParts.ADVANCED_TERMINAL_PART));
        ...
        registry.addWorkstation(ECRecipeCategory.ELITE_TABLE_CRAFTING_CATEGORY, EmiStack.of(ETParts.ELITE_TERMINAL_PART));
        ...
        registry.addWorkstation(ECRecipeCategory.ULTIMATE_TABLE_CRAFTING_CATEGORY, EmiStack.of(ETParts.ULTIMATE_TERMINAL_PART));
    }
}
