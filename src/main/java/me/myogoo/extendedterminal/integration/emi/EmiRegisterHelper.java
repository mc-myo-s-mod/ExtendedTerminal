...
public class EmiRegisterHelper {
    public static void registerCategories(EmiRegistry registry) {
        ItemListModLoadHelper.invokeItemListMod(ETEmiCategory.class, EmiRegistry.class, registry);
    }

    public static void registerWorkStations(EmiRegistry registry) {
        ItemListModLoadHelper.invokeItemListMod(ETEmiWorkstation.class, EmiRegistry.class, registry);
    }

    public static void registerRecipeHandlers(EmiRegistry registry) {
        ItemListModLoadHelper.invokeItemListMod(ETEmiRecipeHandler.class, EmiRegistry.class, registry);
    }

    public static void addRecipes(EmiRegistry registry) {
        ItemListModLoadHelper.invokeItemListMod(ETEmiAddRecipe.class, EmiRegistry.class, registry);
    }
}
