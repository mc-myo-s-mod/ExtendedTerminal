...
public class ETSmithingRecipeHandler<T extends ETTerminalMenu> extends ETTerminalBaseRecipeHandler<T> {
    ...
    protected Result transferRecipe(T menu, EmiRecipe emiRecipe, boolean doTransfer) {
        ...
        var slotToIngredientMap = ETSmithingRecipeTransferHelper.getGuiSlotToIngredientMap(smithingRecipe);
        ...
        if (!doTransfer) {
            ...
            ETSmithingRecipeTransferHelper.performTransfer(menu, smithingRecipe, craftingMissing);
        }
