package me.myogoo.extendedterminal.integration.itemList.emi.extendedcrafting.recipe;
...
public class ECTableRecipe extends BasicEmiRecipe {
    ...
    private void addIngredients(RecipeHolder<ITableRecipe> recipeHolder) {
        ...
        if(adapter instanceof IShapedTableRecipeAdapter shapedAdapter) {
            ...
            this.inputs = new ArrayList<>(Collections.nCopies(adapter.gridSize(), EmiIngredient.of(Ingredient.EMPTY)));
