...
public class ETStonecutterRecipeTransfer<T extends ETTerminalMenu>
        implements IRecipeTransferHandler<T, StonecutterRecipe>, IJeiAbstractRecipeHandler {
    ...
    public @Nullable IRecipeTransferError transferRecipe(T menu, StonecutterRecipe recipe,
        ...
        if (!doTransfer) {
            ...
            ETStoneCutterRecipeTransferHelper.performTransfer(menu, recipe, craftMissing);
        }
