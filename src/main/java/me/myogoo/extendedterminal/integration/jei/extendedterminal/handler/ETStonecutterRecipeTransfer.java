...
public class ETStonecutterRecipeTransfer<T extends ETTerminalMenu> implements IRecipeTransferHandler<T, StonecutterRecipe> {
    private final MenuType<T> menuType;
    private final Class<T> containerClass;
    private final IRecipeTransferHandlerHelper helper;

    public ETStonecutterRecipeTransfer(MenuType<T> menuType, Class<T> containerClass,
    ...
    @Override
    public @Nullable IRecipeTransferError transferRecipe(T menu, StonecutterRecipe recipe,
        ...
        var slotToIngredientMap = ETStoneCutterRecipeTransferHelper.getGuiSlotToIngredientMap(recipe);
        ...
        if (doTransfer) {
            ETStoneCutterRecipeTransferHelper.performTransfer(menu, recipe, AbstractContainerScreen.hasControlDown());
        }
        return null;
    }
}
