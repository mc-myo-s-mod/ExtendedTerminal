...
public class ETCraftingRecipeTransfer<T extends ETTerminalMenu> implements IRecipeTransferHandler<T, CraftingRecipe> {
    ...
    public @Nullable IRecipeTransferError transferRecipe(T menu, CraftingRecipe recipe,
        ...
        if (doTransfer) {
            ETCraftingRecipeTransferHelper.performTransfer(menu, recipe, null, AbstractContainerScreen.hasControlDown());
        }
        return null;
    }
}
