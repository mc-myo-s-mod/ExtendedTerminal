...
public class ItemListTermCraftingHelper {
    ...
    public static NonNullList<Optional<Ingredient>> ensureNxNTableCraftingGrid(Recipe<?> recipe, int gridSize, int recipeWidth, int recipeHeight) {
        var ingredients = MyoTableRecipe.positionedIngredients(recipe);
        var expandedIngredients = NonNullList.<Optional<Ingredient>>withSize(gridSize, Optional.empty());
