...
public abstract class AbstractTableHolderRecipeHandler<T extends ETTerminalBaseMenu<?>, R extends Recipe<?>, H extends RecipeHolder<R>>
    ...
    private final IRecipeType<H> recipeType;

    public AbstractTableHolderRecipeHandler(Class<T> containerClass, MenuType<T> menuType, IRecipeType<H> recipeType) {
    ...
    @Override
    public @NotNull IRecipeType<H> getRecipeType() {
        return recipeType;
    }
