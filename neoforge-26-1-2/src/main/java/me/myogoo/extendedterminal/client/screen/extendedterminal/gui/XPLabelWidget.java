...
public class XPLabelWidget implements ICompositeWidget {
    ...
    private static final int RED_COLOR = 0xFFFF6060;
    private static final int GREEN_COLOR = 0xFF80FF20;
    ...
    public void drawForegroundLayer(GuiGraphicsExtractor guiGraphics, Rect2i bounds, Point mouse) {
        ...
        if(cost > 0) {
            color = GREEN_COLOR;
            guiGraphics.text(Minecraft.getInstance().font, text, x, y, color);
        }
    }
