...
public class UnitedWTMenu extends UnitedTerminalMenu {
    ...
    private static final StreamCodec<FriendlyByteBuf, MagnetMode> MAGNET_MODE_CODEC = NeoForgeStreamCodecs
            .enumCodec(MagnetMode.class);
    ...
    public UnitedWTMenu(int id, Inventory ip, UnitedWTHost host) {
        ...
        registerClientAction(MAGNET_MODE, MAGNET_MODE_CODEC, this::setMagnetMode);
