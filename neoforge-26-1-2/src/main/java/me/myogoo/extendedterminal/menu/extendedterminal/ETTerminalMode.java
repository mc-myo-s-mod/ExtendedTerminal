...
public enum ETTerminalMode {
    ...
    public static final StreamCodec<FriendlyByteBuf, ETTerminalMode> STREAM_CODEC = NeoForgeStreamCodecs
            .enumCodec(ETTerminalMode.class);
    ...
    public Identifier getInventoryId() {
        return switch (this) {
